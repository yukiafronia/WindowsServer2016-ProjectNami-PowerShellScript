...
Invoke-WebRequest -Uri "http://windows.php.net/downloads/releases/php-7.1.4-nts-Win32-VC14-x64.zip" -OutFile C:\php-7.1.4-nts-Win32-VC14-x64.zip
...
Invoke-WebRequest -Uri "https://downloads.sourceforge.net/project/wincache/development/wincache-2.0.0.8-dev-7.1-nts-vc14-x64.exe?r=&ts=1494044906&use_mirror=jaist" -OutFile C:\wincache-2.0.0.8-dev-7.1-nts-vc14-x64.exe
cd C:\
...
Invoke-WebRequest -Uri "https://github.com/ProjectNami/projectnami/archive/1.5.7.zip" -OutFile C:\projectnami-1.5.7.zip
New-Item C:\Nami -itemType Directory
Move-Item C:\projectnami-1.5.7.zipp C:\Nami
cd C:\Nami
